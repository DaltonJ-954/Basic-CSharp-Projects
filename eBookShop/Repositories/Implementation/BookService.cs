...
public class BookService : IBookService
{
    ...
    {
        var data = (from book in context.Book join author in context.Author
                    ...
                    select new Book { Id = book.Id, AuthorId = book.AuthorId,
                    GenreId = book.GenreId, Isbn = book.Isbn, PublisherId = book.PublisherId,
                    Title = book.Title, TotalPages = book.TotalPages, GenreName = genre.Name,
                    AuthorName = author.AuthorName, PublisherName = publisher.PublisherName,
                    }
                    ).ToList();
        return data;
    }
